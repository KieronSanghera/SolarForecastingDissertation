...
<!--Divider-->
<?php $__currentLoopData = $britonFerryForecast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forecast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if($loop->first): ?>
    ...
    <div class="p-3">
        ...
        <div class="bg-gray-500 border border-gray-800 rounded shadow">
            ...
            <div class="p-5">
                <h6 class="text-white"><?php echo e($forecast->forecasted_mv); ?> kWh </h6>
            </div>
        </div>
        <!--/Graph Card-->
    </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/forecasts/BritonFerry.blade.php ENDPATH**/ ?>