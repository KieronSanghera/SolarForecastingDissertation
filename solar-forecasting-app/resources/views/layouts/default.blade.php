    ...
    <div class="fixed bg-neutral-200 top-0 left-0 right-0 z-50">
      <nav>
        <div class="container mx-auto px-6 py-4 flex justify-between items-center pt-10">
          <a class="font-bold text-2xl lg:text-4xl" href=" {{ route('index.show') }} ">
            Solar Forecasts
          </a>
          <div class="block lg:hidden">
            ...
            <div class="hidden border-4 border-neutral-400 bg-neutral-200 fixed mobile-menu top-40 transform -translate-x-1/2 -translate-y-1/2 rounded">
              <ul class="">
                <li class="active"><a href="{{ route('index.show') }}" class="block text-sm px-2 py-4 hover:bg-neutral-400">Home</a></li>
                <li><a href="{{ route('about.show') }}" class="block text-sm px-2 py-4 hover:bg-neutral-400 transition duration-300">About</a></li>
                <li><a href=" {{ route('forecast.show') }} " class="block text-sm px-2 py-4 hover:bg-neutral-400 transition duration-300">Forecasts</a></li>
              </ul>
            </div>
            <script>
          ...
          <div class="hidden lg:block">
            <ul class="inline-flex">
              <li><a class="px-4 font-bold" href="{{ route('index.show') }}">Home</a></li>
              <li><a class="px-4 hover:text-gray-800" href="{{ route('about.show') }}">About</a></li>
              <li><a class="px-4 hover:text-gray-800" href=" {{ route('forecast.show') }} ">Forecasts</a></li>
            </ul>
          </div>
        </div>
      </nav>
    ...
    <div class="container mx-auto px-6 pt-10 pb-6">
      <div class="flex flex-wrap">
        <div class="w-full md:w-1/4 text-center md:text-left">
          ...
          <ul class="mb-4">
            <li class="mt-2">
              <a href="{{ route('faq.show') }}" class="hover:underline text-gray-600 hover:text-orange-500">FAQ</a>
            </li>
            <li class="mt-2">
        ...
        <div class="w-full md:w-1/4 text-center md:text-left">
          ...
          <ul class="mb-4">
            ...
            <li class="mt-2">
              <a href="{{ route('about.show') }}" class="hover:underline text-gray-600 hover:text-orange-500">About Us</a>
            </li>
            <li class="mt-2">
